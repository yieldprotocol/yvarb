...
export interface VaultCreatedStateInterface extends utils.Interface {
  functions: {
...
export interface VaultCreatedState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VaultCreatedStateInterface;
